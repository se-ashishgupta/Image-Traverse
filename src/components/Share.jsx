...
const Share = ({ photodata, shareOpen, setShareOpen, shareDropUpRef }) => {
    ...
    return (
        <div className={`absolute bottom-[125%] bg-white  shadow-lg px-2 rounded-lg ${shareOpen ? "h-max py-4 border-[1px]" : "h-0 py-0 border-0 duration-0"} flex  flex-col gap-2 transition-all overflow-hidden`}>
